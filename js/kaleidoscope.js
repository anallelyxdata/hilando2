$( document ).ready( function () {
  ...
  if ( n ) {
    for ( var i = 0; i <= n * 2; i++ ) {
      tiles += [ '<div class="tile t', i, '"><div class="image" id="imagek',i,'"></div></div>' ].join( '' );
    }
  }
  ...
  function move( x, y ) {
    $image.css( 'background-position', [ x + "px" ].join( ' ' ) );
  }
